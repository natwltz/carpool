...
<head>
    ...
    <title>Modifier un utilisateur - Carpool</title>
...
<body class="page-specifique">
    ...
    <main class="conteneur-central">
        <h1 class="titre-page">Modifiez un utilisateur</h1>

        <form class="formulaire" action="processUser.php" method="post">
            <div class="groupe-saisie">
                <label for="firstname">Prénom :</label>
                <input type="text" id="firstname" name="firstname" class="champ-texte" value="<?= $firstname ?>">
            </div>
            <div class="groupe-saisie">
                <label for="lastname">Nom :</label>
                <input type="text" id="lastname" name="lastname" class="champ-texte" value="<?= $lastname ?>">
            </div>
            <div class="groupe-saisie">
                <label for="mail">Email :</label>
                <input type="email" id="mail" name="mail" class="champ-texte" value="<?= $mail ?>">
            </div>
            <div class="groupe-saisie">
