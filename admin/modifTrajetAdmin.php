...
$heure = isset($recordset[0]) ? hsc($recordset[0]["trajet_heure"]) : '';
$ville = isset($recordset[0]) ? hsc($recordset[0]["trajet_ville"]) : '';
$date = isset($recordset[0]) ? hsc($recordset[0]["trajet_date"]) : '';
$nbpassager = isset($recordset[0]) ? hsc($recordset[0]["trajet_nbpassager_max"]) : '';
...
<head>
    ...
    <title>Modifier un trajet Admin - Carpool</title>
    <link rel="stylesheet" href="../style/style.css">
    <link rel="stylesheet" href="../style/modifTrajetAdmin.css">
...
<body class="page-specifique">
    ...
    <main class="conteneur-central">
        ...
        <form class="formulaire" action="processTrajetAdmin.php" method="post" enctype="multipart/form-data">
            ...
            <div class="groupe-saisie">
                ...
                <div class="selecteur-passagers">
                    <input type="radio" name="passager_max" id="p1" value="1" <?= $nbpassager == 1 ? "checked" : "" ?>>
                    <label for="p1" class="bouton-passager">1</label>
                    <input type="radio" name="passager_max" id="p2" value="2" <?= $nbpassager == 2 ? "checked" : "" ?>>
                    <label for="p2" class="bouton-passager">2</label>
                    <input type="radio" name="passager_max" id="p3" value="3" <?= $nbpassager == 3 ? "checked" : "" ?>>
                    <label for="p3" class="bouton-passager">3</label>
                    <input type="radio" name="passager_max" id="p4" value="4" <?= $nbpassager == 4 ? "checked" : "" ?>>
